...
const CHAPTERS = [
  ...
  // ── Giri ─────────────────────────────────────────────────────
  {
    ...
    emoji: "🍫",
    story: "Giri's chocolate shop is running low! She needs multiplication to work out how many chocolate bars, truffles, and fudge squares to order before the morning rush. The whole neighborhood depends on Giri's shop — help her get the order numbers just right!",
    mode: "multiply",
    unlockAt: 0,
    passPct: 80,
  },
  {
    ...
    emoji: "🎁",
    story: "Giri is putting together treat boxes for every friend on the street. She needs division to figure out how many chocolates go in each box so that every box has exactly the same amount. Help Giri divide the chocolates evenly so everyone gets the same delicious surprise!",
    mode: "divide",
    unlockAt: 0,
    passPct: 80,
  },
  {
    ...
    emoji: "🧁",
    story: "Giri has invented a brand-new chocolate recipe and wants to make enough for the entire neighborhood! She needs multiplication to scale up every ingredient in the recipe. Even Bermione stopped by early to taste-test — and she gave a very enthusiastic \"Mmm!\" between bites. Help Giri multiply the recipe!",
    mode: "multiply",
    unlockAt: 1,
    passPct: 80,
  },
