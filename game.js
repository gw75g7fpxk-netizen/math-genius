...
const CHARACTERS = [
  ...
  },
  {
    ...
    description: 'A friendly rock giant from the volcano — small enough among her kind to visit parts of the neighborhood without causing too much disruption. She travels by leaping great distances, and her landings make the earth shake. She is endlessly fascinated by the tiny neighborhood friends and their tiny neighborhood things.',
  },
];
...
const THEME_CHARACTERS = {
  ...
  // Chapter 2 – The Neighborhood: Giri out, Bermione in; minor shuffle
  ...
  // Chapter 3 – The Volcano: friends who visit + Lligen visiting the neighborhood
...
const CHAPTERS = [
  ...
  // Stories set in the neighborhood locations described in
  ...
  },
  {
    ...
    emoji: "🍫",
    story: "It's the end of Humphrey's morning walk and Giri's Chocolate Shop is just ahead! Today Giri has a new batch of his famous chocolate treats, and Humphrey needs multiplication to help calculate how many of each treat to pack for the whole neighborhood. Even Bermione showed up early — for the chocolate, obviously. Help Humphrey and Giri sort out the orders!",
    mode: "multiply",
    unlockAt: 1,
    passPct: 80,
  },
  ...
  },
  {
    ...
    character: 'humphrey',
    charIdx: 9,
    title: "Chapter 5: Neighborhood Grand Tour",
    emoji: "🗺️",
    story: "Humphrey is giving new neighbour Lilli (Giri's niece — a kid giraffe who runs the sandwich shop in Kiki's lab) a grand tour of the neighborhood! They visit the Ice Cream Hill, the Cheese Tree Forest, the Hot Chocolate Spring, and Margret's pool — all in one afternoon. Help Humphrey calculate distances and timings to fit everything in!",
    mode: "both",
    unlockAt: 3,
    passPct: 80,
  },
  ...
  },
  {
    ...
    character: 'fluffy',
    charIdx: 9,
    title: "Chapter 5: The Neighborhood Great Day Out",
    emoji: "🌟",
    story: "Fluffy is having the best day ever — she bounced through the Cheese Forest, slid down the Ice Cream Hill, and scooped hot chocolate at the spring! Now she is helping Margret set up chairs for a neighborhood gathering and needs multiplication and division to count the chairs, snacks, and how many times she has accidentally bumped into something today. Help Fluffy wrap up the most wonderfully bumpy day!",
    mode: "both",
    unlockAt: 3,
    passPct: 80,
  },
  ...
  },
  {
    ...
    emoji: "🏖️",
    story: "Roo and Humphrey are building an enormous sandcastle fort at the lake — as big as a real house! Roo needs division to calculate how to divide the sand between the different towers and walls. She uses Blanket as a measuring rope to mark out each section. Help Roo design and build the ultimate neighborhood sandcastle!",
    mode: "divide",
    unlockAt: 0,
    passPct: 80,
  },
  {
    ...
    emoji: "🧀",
    story: "The Cheese Tree Forest branches are falling and Roo is using Blanket as a basket to carry them back to share with the neighborhood! She needs multiplication to count how many branches fit per trip and how many journeys she needs to make. Fluffy is bouncing around in the trees above her, making branches fall faster. Help Roo collect the cheese harvest!",
    mode: "multiply",
    unlockAt: 1,
    passPct: 80,
  },
  ...
  },
  {
    ...
    emoji: "🦄",
    story: "Peggy the Pegasus is patrolling the neighborhood today and has asked Roo to help count all the friends at each location — the Hot Chocolate Spring, the Ice Cream Hill, the lake, and Margret's pool. Roo needs multiplication and division to calculate patrol routes and response times. Help Roo and Peggy keep the whole neighborhood safe!",
    mode: "both",
    unlockAt: 3,
    passPct: 80,
  },
  ...
  },
  {
    ...
    emoji: "🗺️",
    story: "Tigey Avinia is drawing a grand map of 'her neighborhood in France' — the Hot Chocolate Spring, the Cheese Tree Forest, La Grande Piste de Ski, La Rivière des Beignets, and her totally imaginary French café. She needs multiplication and division to calculate distances and label everything in 'French'. Help Tigey Avinia complete her magnifique cartographic masterpiece!",
    mode: "both",
    unlockAt: 3,
    passPct: 80,
  },
  ...
  // ── Tigey ────────────────────────────────────────────────────
  {
    ...
    character: 'tigey',
    charIdx: 5,
    title: "Chapter 1: Neighborhood Walk with Tigey",
    emoji: "🌸",
    story: "Tigey is setting out on a long walk of the neighborhood today — past the Hot Chocolate Spring, through the Cheese Tree Forest, and all the way to Giri's Chocolate Shop! She needs multiplication to calculate how many steps between each stop and how many friends she will meet along the way. Help Tigey plan the perfect neighborhood morning walk!",
    mode: "multiply",
    unlockAt: 0,
    passPct: 80,
  },
  ...
  },
  {
    ...
    emoji: "🏖️",
    story: "Tigey and Vaporeon are building a sandcastle fort at the lake! Vaporeon uses her water cannon to shape the walls — Vaporeon! — while Tigey does the mathematical planning. She needs multiplication and division to calculate how much sand goes in each section and how many towers the fort needs. Help Tigey design the greatest sandcastle fort the neighborhood has ever seen!",
    mode: "both",
    unlockAt: 2,
    passPct: 80,
  },
  {
    ...
    character: 'tigey',
    charIdx: 9,
    title: "Chapter 5: Tigey's Neighborhood Street Festival",
    emoji: "🎪",
    story: "Tigey is organising the neighborhood's first-ever Street Festival — with game stalls, snack tables, and a grand parade down the main street! She needs multiplication and division to allocate space for each stall, calculate how many treats to prepare for every attendee, and arrange the parade lineup. Everyone has signed up and Bermione has claimed three stall spots (one is definitely just for her sammich). Help Tigey plan the most spectacular street festival the neighborhood has ever seen!",
    mode: "both",
    unlockAt: 3,
    passPct: 80,
  },
  ...
  },
  {
    ...
    character: 'bermione',
    charIdx: 9,
    title: "Chapter 5: The Grand Neighborhood Welcome",
    emoji: "🏆",
    story: "Hermione talked Bermione into hosting a Grand Neighborhood Welcome for all the street's residents — a celebration of community, friendship, and one or two spectacular sammich moments. Bermione grumbled through every planning meeting but secretly put in enormous effort. She needs multiplication and division to organise every detail. Help Bermione (and her hidden heart of gold) pull off the greatest neighborhood welcome ever!",
    mode: "both",
    unlockAt: 3,
    passPct: 80,
  },
  ...
  },
  {
    ...
    emoji: "🌟",
    story: "Vaporeon is performing her legendary Grand Water Finale at the lake — the most spectacular water cannon display the neighborhood has ever seen, with blasts timed to music! Margret has brought her mermaid friends through the portal to watch, and Bermione set up a sammich station at the water's edge (and ate most of it herself). Vaporeon! Help Vaporeon calculate the perfect timing and water quantities for the most magnificent show in neighborhood history!",
    mode: "both",
    unlockAt: 3,
    passPct: 80,
  },
  ...
  // and Lligen (smaller, more suited to neighborhood visits). The volcano-visit
  // chapters feature Giganta as the host; Lligen gets her own chapters as a
  // playable character visiting the neighborhood (IDs 142–146 below).
  // ── Kiki ──────────────────────────────────────────────────────
  {
    id: 117,
    character: 'kiki',
  ...
  // ── Lligen ────────────────────────────────────────────────────
  {
    ...
    emoji: "🪨",
    story: "Lligen has heard so much about the neighborhood from Kiki's visits and from the donut river that she wants to see it for herself! She crouches at the volcano's summit, springs with all her might — and FLIES through the air in an enormous arc, the whole world stretching out below her — and lands with a tremendous THOOM on the grassy edge of the neighborhood. The ground shakes for a full five seconds. Every friend comes running to see what happened. Help Lligen calculate the distance of her legendary leap from the volcano all the way to the neighborhood!",
    mode: "multiply",
    unlockAt: 0,
    passPct: 80,
  },
  ...
  },
  {
    ...
    emoji: "🍫",
    story: "Giri has been preparing something very special ever since he heard Lligen was coming to the neighborhood. He arrives at the lakeshore carrying an enormous crate: chocolate-covered rocks made to giant size — the most prized delicacy from the volcano village, crafted especially for Lligen. Lligen's eyes go very wide. \"ROCKS-CHOCOLAT!\" she rumbles with great reverence. Giri beams. Help Giri calculate the number of giant chocolate rocks he made and how many are in each portion so Lligen can savour every one!",
    mode: "multiply",
    unlockAt: 4,
    passPct: 80,
  },
  {
    ...
    emoji: "🧜",
    story: "Lligen wades into the lake and settles down comfortably — it's the one spot in the neighborhood where she actually fits. She is happily nibbling her chocolate rocks when the water begins to shimmer with a familiar glow — a shimmer that Anna and Annabell know well. The mermaids rise through the surface of the lake in a swirl of magic, blinking in surprise at the enormous rock giant sitting in their lake. They stare at Lligen. Lligen stares at them. \"HELLO SMALL WATER FRIENDS!\" she booms. Anna and Annabell dissolve into laughter and swim over immediately. Help Lligen, Anna, and Annabell calculate how to share the remaining chocolate rocks — there is plenty for everyone!",
    mode: "both",
    unlockAt: 5,
    passPct: 80,
  },
...
const STORY_THEMES = [
  {
    ...
    emoji: '👫',
    description: 'Play alongside your neighborhood friends in their everyday adventures!',
  },
  {
    id: 2,
    title: 'Chapter 2: The Neighborhood',
    emoji: '🏘️',
    description: 'Explore the magical neighborhood — the Ice Cream Hill, the Cheese Tree Forest, the Hot Chocolate Spring, the Donut River, and more!',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    emoji: '🌋',
    description: 'A visit to the volcano! Join Kiki, Humphrey, Maggie, Fluffy, and Hermione as they trek to meet the rock giants — and follow Lligen, the friendly rock giant, as she makes her first visit to the neighborhood.',
  },
  {
    id: 5,
